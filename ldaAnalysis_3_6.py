...
if __name__ == "__main__":
    ...
    ps = [
        mp.Process(target=subprocess, args=(2, 26)),
        mp.Process(target=subprocess, args=(26, 41)),
        mp.Process(target=subprocess, args=(41, 56)),
        mp.Process(target=subprocess, args=(56, 71)),
        mp.Process(target=subprocess, args=(71, 81)),
        mp.Process(target=subprocess, args=(81, 91)),
        mp.Process(target=subprocess, args=(91, 96)),
        mp.Process(target=subprocess, args=(96, 101))]
